<template>
    <div class="py-10 px-6 grid md:grid-cols-4 gap-3">
        <div class="md:col-span-3">
            <h1 class="mb-6 text-3xl">The Title</h1>
            <p>The description of the job...</p>

            <a href="#" class="inline-block mt-6 py-4 px-6 bg-teal-700 text-white rounded-xl">Apply</a>
        </div>
        ...
        <div class="md:col-span-1 p-6 bg-teal-700 text-white rounded-xl">
            ...
            <p class="mb-2">Position location</p>
            <p>Salary</p>
            <hr class="my-6 opacity-30">
            <p>Posted at Dec. 1.2022</p>
        </div>
    </div>
</template>